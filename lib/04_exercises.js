...
function assert(expected, actual) {
  var message = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "Test";
...
var assert_true = function assert_true(actual, message) {
  assert(true, actual, message);
};
var assert_false = function assert_false(actual, message) {
...
function arrayToList(arr) {
  return arr.reduceRight(function (list, value) {
...
function assert_equal(value1, value2) {
  if (isObject(value1) && isObject(value2)) {
    if (Object.keys(value1) === Object.keys(value2)) {
      return Object.values(value1).map(function (current, index) {
        return assert_equal(current, Object.values(value2)[index]);
...
var test_obj = { here: { is: "an" }, object: 2 };
